...
exports.defaultSettings = {
    method: sync_method_model_1.SyncMethod.Repo,
    [sync_method_model_1.SyncMethod.Repo]: {
        url: null
    },
    [sync_method_model_1.SyncMethod.File]: {
        path: null,
        bob: null
    }
};
...
const file_service_1 = __webpack_require__(/*! ./file.service */ "./src/services/file.service.ts");
...
class FactoryService {
    static generate(syncMethod) {
        ...
        return new repo_service_1.RepoService();
    }
}
FactoryService.methods = {
    [sync_method_model_1.SyncMethod.Repo]: repo_service_1.RepoService,
    [sync_method_model_1.SyncMethod.File]: file_service_1.FileService
};
...
class FileSystemService {
    exists(path) {
        return new Promise(res => fs_extra_1.exists(path, res));
    }
    mkdir(path) {
        return new Promise(res => fs_extra_1.mkdir(path, () => res()));
    }
    read(path) {
        return new Promise(res => fs_extra_1.readFile(path, "utf-8", (_, data) => res(data)));
    }
    write(path, data) {
        return new Promise(res => fs_extra_1.writeFile(path, data, () => res()));
    }
}
...
class SettingsService {
    getSettings() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const exists = yield state_1.state.fs.exists(filepath);
            if (!exists) {
                yield this.setSettings(settings_model_1.defaultSettings);
                return settings_model_1.defaultSettings;
            }
            try {
                const settings = JSON.parse(yield state_1.state.fs.read(filepath));
                const newSettings = lodash_1.merge(settings_model_1.defaultSettings, settings);
                if (JSON.stringify(newSettings) !== JSON.stringify(settings)) {
                    yield this.setSettings(settings);
                }
                return newSettings;
            }
            catch (err) {
    ...
    setSettings(settings) {
        return __awaiter(this, void 0, void 0, function* () {
            const exists = yield state_1.state.fs.exists(state_1.state.context.globalStoragePath);
            if (!exists) {
                yield state_1.state.fs.mkdir(state_1.state.context.globalStoragePath);
            }
            const filepath = path_1.resolve(state_1.state.context.globalStoragePath, "settings.json");
            state_1.state.fs.write(filepath, JSON.stringify(lodash_1.merge(settings_model_1.defaultSettings, settings), null, 2));
        });
    }
    openSettings() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield vscode_1.window.showTextDocument(document, vscode_1.ViewColumn.One, true);
        });
    }
    resetSettings() {
        return __awaiter(this, void 0, void 0, function* () {
            this.setSettings(settings_model_1.defaultSettings);
            yield state_1.state.sync.reset();
        });
    }
}
